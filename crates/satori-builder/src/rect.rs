...
use satori_css::style::{ComputedStyle, Display, ObjectFit};

use crate::background_image::render_background_image;
use crate::border::{render_border, BorderArgs};
use crate::border_radius::radius_path;
use crate::clip_path::{build_clip_path, clip_path_url, parse_shape};
use crate::mask_image::build_mask_image;
use crate::shadow::{box_shadow, BoxShadowArgs};
use crate::xml::{build_xml, AttrValue};
...
pub fn build_content_mask(
    ...
    let is_overflow_hidden = matches!(style.overflow, Some(satori_css::style::Overflow::Hidden));
    ...
    let border_mask = crate::border::content_mask_border(
...
pub fn render_rect(
    ...
    let is_overflow_hidden =
        matches!(style.overflow, Some(satori_css::style::Overflow::Hidden));
...
fn render_image_layer(
    ...
    let border_carve = crate::border::content_mask_border(
        left as f32,
        top as f32,
        width as f32,
        height as f32,
