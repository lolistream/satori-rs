...
use satori_css::style::{ComputedStyle, RadiusValue};

use crate::xml::js_number_to_string;
...
pub fn radius_path(left: f32, top: f32, width: f32, height: f32, style: &ComputedStyle) -> String {
    ...
    s.push('M');
    s.push_str(&crate::xml::js_number_to_string_f64(left + tl[0]));
    s.push(',');
    s.push_str(&crate::xml::js_number_to_string_f64(top));
    s.push_str(" h");
    s.push_str(&crate::xml::js_number_to_string_f64(width - tl[0] - tr[0]));
    s.push_str(" a");
    s.push_str(&crate::xml::js_number_to_string_f64(tr[0])); s.push(','); s.push_str(&crate::xml::js_number_to_string_f64(tr[1]));
    s.push_str(" 0 0 1 ");
    s.push_str(&crate::xml::js_number_to_string_f64(tr[0])); s.push(','); s.push_str(&crate::xml::js_number_to_string_f64(tr[1]));
    s.push_str(" v");
    s.push_str(&crate::xml::js_number_to_string_f64(height - tr[1] - br[1]));
    s.push_str(" a");
    s.push_str(&crate::xml::js_number_to_string_f64(br[0])); s.push(','); s.push_str(&crate::xml::js_number_to_string_f64(br[1]));
    s.push_str(" 0 0 1 ");
    s.push_str(&crate::xml::js_number_to_string_f64(-br[0])); s.push(','); s.push_str(&crate::xml::js_number_to_string_f64(br[1]));
    s.push_str(" h");
    s.push_str(&crate::xml::js_number_to_string_f64(br[0] + bl[0] - width));
    s.push_str(" a");
    s.push_str(&crate::xml::js_number_to_string_f64(bl[0])); s.push(','); s.push_str(&crate::xml::js_number_to_string_f64(bl[1]));
    s.push_str(" 0 0 1 ");
    s.push_str(&crate::xml::js_number_to_string_f64(-bl[0])); s.push(','); s.push_str(&crate::xml::js_number_to_string_f64(-bl[1]));
    s.push_str(" v");
    s.push_str(&crate::xml::js_number_to_string_f64(bl[1] + tl[1] - height));
    s.push_str(" a");
    s.push_str(&crate::xml::js_number_to_string_f64(tl[0])); s.push(','); s.push_str(&crate::xml::js_number_to_string_f64(tl[1]));
    s.push_str(" 0 0 1 ");
    s.push_str(&crate::xml::js_number_to_string_f64(tl[0])); s.push(','); s.push_str(&crate::xml::js_number_to_string_f64(-tl[1]));
